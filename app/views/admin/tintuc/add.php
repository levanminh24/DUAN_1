        ...
        <div class="card-body">
            <form action="index.php?act=addtintuc" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="giasp" name="tacgia">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="soluong" name="tieude">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="mota" name="noidunghai" rows="5"></textarea>
