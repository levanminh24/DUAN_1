              ...
              <div class="header-align">
                <div class="header-navigation-area position-relative">
                  <ul class="main-menu nav">
                    <li><a href="index.php?redirect=listspHome"><span>Home</span></a>
                    <li class=""><a href="#/"><span>Giới thiệu</span></a>
                    </li>
                    
                    <ul class="main-menu nav">
                    <li class="has-submenu">
    <a href="?redirect=sanphamtheodm"><span>Danh mục</span></a>
    <ul class="submenu-nav">
        <?php
        $listdm = loadall_danhmuc();
        foreach ($listdm as $dm) {
            extract($dm);
            echo '<li><a href="?redirect=sanphamtheodm&id=' . $id . '"><span>' . $name . '</span></a></li>';
        }
        ?>
    </ul>
</li>
