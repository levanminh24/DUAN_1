        ...
        <div class="guilienhe">
            <div class="bentrai">
                ...
                <div class="thongtinlienhe">
                    ...
                    <p><span>Email:</span> levminh256@gmail.com</p>
                </div>
            </div>
            <div class="benphai">
                <form action="index.php?redirect=lienhe" method="post">
                <div class="mb-3">
                    <label for="hovatenlh" class="form-label">Họ và Tên</label>
                    <input type="text" id="hovatenlh" class="form-control" placeholder="Nhập họ và tên..." name="hovaten">
                
                </div>
                <div class="mb-3">
                    <label for="emaillh" class="form-label">Email: </label>
                    <input type="text" id="emaillh" class="form-control" placeholder="Nhập email..." name="email">
                  
                </div>
                <div class="mb-3">
                    <label for="sodienthoailh" class="form-label">Số điện thoại</label>
                    <input type="text" id="sodienthoailh" class="form-control" placeholder="Nhập số điện thoại..." name="sodienthoai">
                  
                </div>
                <div class="mb-3">
                    <label for="noidunglh" class="form-label">Mô tả</label>
                    <textarea class="form-control" rows="5" id="noidunglh" name="noidung" placeholder="Nhập nội dung liên hệ..."></textarea>
                
                </div>
                <input type="submit" value="Gửi liên hệ" name="guilienhe">
            </form>
        </div>
    </div>
</div> 